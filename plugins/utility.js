...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.data[0].urls.original }, caption: '😎 Random Garl image' }, { quoted: mek });
    } catch (e) {
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.url }, caption: '🩵 Random Waifu image' }, { quoted: mek });
    } catch (e) {
        reply("I cant find this anime.");
        console.log(e);
    }
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.url }, caption: '🩷 Random neko image' }, { quoted: mek });
    } catch (e) {
        reply("I cant find this anime.");
        console.log(e);
    }
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.url }, caption: '❤️‍🔥 Random megumin image' }, { quoted: mek });
    } catch (e) {
        reply("I cant find this anime.");
        console.log(e);
    }
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.images[0].url }, caption: '😎 Random maid image' }, { quoted: mek });
    } catch (e) {
        reply("I cant find this anime.");
        console.log(e);
    }
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: res.data.url }, caption: '😎 Random awoo image' }, { quoted: mek });
    } catch (e) {
        reply("I cant find this anime.");
        console.log(e);
    }
...
cmd({
    ...
    try {
        ...
        await conn.sendMessage(from, { image: { url: randomImg }, caption: '> Anime Image' }, { quoted: mek });
    } catch (e) {
        console.log(e);
        reply(`${e.message}`);
    }
...
cmd({
    ...
    try {
        ...
        const response = await axios.get(apiUrl);
        const data = response.data;
        await conn.sendMessage(from, { image: { url: data.message }, caption: '> Random Dog 🐶' }, { quoted: mek });
    } catch (e) {
        console.log(e);
