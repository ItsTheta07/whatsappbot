...
cmd({
    ...
    try {
        ...
        guideText += `├─ *Set Bot Name:* .botname Research-Bot\n`;
        guideText += `├─ *Set Owner Name:* .ownername Admin\n`;
        ...
        guideText += `> ${config.DESCRIPTION || config.BOT_NAME}`;
...
cmd({
    ...
    try {
        ...
        envText += `├─ *Bot Name:* ${config.BOT_NAME || 'Research-Bot'}\n`;
        envText += `├─ *Owner:* ${config.OWNER_NAME || 'Admin'}\n`;
